...
BEGIN
    IF TG_OP = 'INSERT' THEN
        INSERT INTO profit_loss_data_sel_changes (
            ...
            depreciation, interest, profit_before_tax, tax, net_profit, dividend_amount
        ) VALUES (
            ...
            NEW.profit_before_tax, NEW.tax, NEW.net_profit, NEW.dividend_amount
        );
    ...
    ELSIF TG_OP = 'DELETE' THEN
        INSERT INTO profit_loss_data_sel_changes (
            ...
            OLD.profit_before_tax, OLD.tax, OLD.net_profit, OLD.dividend_amount
        );
    END IF;
    RETURN NEW;
END;
